    ...
    return (
      ...
      >
        <div className="menu-content">
          <List>
            <ListItem>
              <Typography variant="h5">Macrostrat</Typography>
            ...
            <div className="menu-options">
              <ListItem
                ...
                style={{
                  backgroundColor: mapHasBedrock ? "#eee" : "transparent",
                }}
              >
                <ListItemIcon>
                  <BedrockIcon size={25} />
              ...
              <ListItem
                ...
                onClick={toggleLines}
                style={{
                  backgroundColor: mapHasLines ? "#eee" : "transparent",
                }}
              >
                <ListItemIcon>
                  <LineIcon size={25} />
              ...
              <ListItem
                ...
                style={{
                  backgroundColor: mapHasColumns ? "#eee" : "transparent",
                }}
              >
                <ListItemIcon>
                  <ColumnIcon size={25} />
              ...
              <ListItem
                ...
                style={{
                  backgroundColor: mapHasFossils ? "#eee" : "transparent",
                }}
              >
                <ListItemIcon>
                  <FossilIcon size={25} />
              ...
              <ListItem
                ...
                style={{
                  backgroundColor: mapHasSatellite ? "#eee" : "transparent",
                }}
              >
