      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            ...
            Macrostrat's geologic map is a seamless integration of over{" "}
            <a className="ref-link" href="/map/sources">
              200 geologic maps
            </a>{" "}
            from around the world and at numerous scales that have been
            homogenized into a single database. As you zoom in and out of the
            map, scale-appropriate geologic maps are shown, and clicking on the
            map reveals primary data about each unit.
            <br />
            <br />
            Looking for the old version? You can find it at{" "}
            <a className="ref-link" href="/map-raster" target="_blank">
              https://macrostrat.org/map-raster
            </a>
            ...
            <span className="about-section">
              ...
              , P.I. and scientific lead. Puneet Kishor, initial earth-base and
              literature search development.
            </span>
            <span className="about-section">
              Funding for core Macrostrat development via NSF EAR-1150082,
              Macrostrat—geologic map integration via NSF ICER-1440312, and
              literature integration via NSF ICER-1343760.
            </span>
          </DialogContentText>
        </DialogContent>
        <DialogActions>
