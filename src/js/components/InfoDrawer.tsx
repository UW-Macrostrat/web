              ...
              <div className="infodrawer-content">
                <Grid container alignItems="center" alignContent="center">
                  <Grid
                    item
                    xs={12}
                    classes={{ "grid-xs-12": "infodrawer-header-grid" }}
                  >
                        ...
                        source.macrostrat.liths.length ? (
                          ...
                          >
                            ...
                            >
                              ...
                              {source.macrostrat && source.macrostrat.lith_types
                                ? source.macrostrat.lith_types.map(
                                    (lithType, i) => {
                                      return (
                                        <AttrChip
                                          key={lithType.name + lithType.color}
                                          name={lithType.name || "other"}
                                          color={lithType.color}
                                        />
                                      );
                                    }
                                  )
                        ...
                        source.macrostrat.environs.length ? (
                          ...
                          >
                            ...
                            >
                              ...
                              {source.macrostrat &&
                              source.macrostrat.environ_types
                                ? source.macrostrat.environ_types.map(
                                    (environType, i) => {
                                      return (
                                        <AttrChip
                                          key={
                                            environType.name + environType.color
                                          }
                                          name={environType.name || "other"}
                                          color={environType.color}
                                        />
                                      );
                                    }
                                  )
                        ...
                        source.macrostrat.econs.length ? (
                          ...
                          >
                            ...
                            >
                              ...
                              {source.macrostrat && source.macrostrat.econ_types
                                ? source.macrostrat.econ_types.map(
                                    (econType, i) => {
                                      return (
                                        <AttrChip
                                          key={econType.name + econType.color}
                                          name={econType.name || "other"}
                                          color={econType.color}
                                        />
                                      );
                                    }
                                  )
