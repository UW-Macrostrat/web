"use strict";
// taken from https://github.com/TerriaJS/terriajs/blob/master/lib/Map/computeRingWindingOrder.js
/*global require*/
...
function computeRingWindingOrder(ring) {
  ...
  if (isNaN(twiceArea)) {
    throw new DeveloperError("map.computeRingWindingOrder.devError");
  }
