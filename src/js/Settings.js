export const SETTINGS = {
  ...
  burwellTileDomain: (window.location.hostname === 'localhost' ? 'https://tiles.macrostrat.org' : ((window.location.hostname === 'dev.macrostrat.org') ? 'https://devtiles.macrostrat.org' : 'https://tiles.macrostrat.org')),
  apiDomain: (window.location.hostname === 'localhost') ? 'https://dev.macrostrat.org' : `https://${window.location.hostname}`,
