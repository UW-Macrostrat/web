...
The map now has a _Dark mode_ with a matching map style. By default, this follows your system's
"preferred color scheme", but it can be toggled on and off from the _Settings_ panel.
