...
class ElevationChart extends Component {
  ...
  drawChart() {
    ...
    let minElevation = min(this.props.elevationData, (d) => {
      return d.elevation;
    });
    let maxElevation = max(this.props.elevationData, (d) => {
      return d.elevation;
    });

    let minElevationBuffered =
      minElevation - (maxElevation - minElevation) * 0.2;
    let maxElevationBuffered =
      maxElevation + (maxElevation - minElevation) * 0.1;

    this.exageration =
      max(this.props.elevationData, (d) => {
        return d.d;
      }) /
      width /
    ...
    x.domain(
      extent(this.props.elevationData, (d) => {
        return d.d;
      })
    );
