  ...
  render() {
    return (
      <div className="map-source">
        ...
        <AgeChip
          b_int={this.props.source.b_int}
          t_int={this.props.source.t_int}
        ></AgeChip>
        ...
        <div className="map-source-attrs">
          ...
          {this.props.source.strat_name &&
          this.props.source.strat_name.length ? (
            <div className="map-source-attr">
              <span className="attr">Stratigraphic name(s): </span>{" "}
              {this.props.source.strat_name}
            </div>
          ) : (
            ""
          ...
          {this.props.source.descrip && this.props.source.descrip.length ? (
            <div className="map-source-attr">
              <span className="attr">Description: </span>{" "}
              {this.props.source.descrip.substr(0, 250)}
                ...
                <span>
                  ...
                  <span className={this.state.descripExpanded ? "hidden" : ""}>
                    <IconButton
                      ...
                      onClick={this.toggleDescripExpand}
                    >
                      <ExpandMoreIcon />
                    </IconButton>
                  </span>
                  ...
                  <Collapse
                    in={this.state.descripExpanded}
                    timeout="auto"
                    unmountOnExit
                  >
                    ...
                    {this.props.source.descrip.substr(
                      250,
                      this.props.source.descrip.length
                    )}
                  </Collapse>
                </span>
              ) : (
          ...
          {this.props.source.comments && this.props.source.comments.length ? (
            <div className="map-source-attr">
              <span className="attr">Comments: </span>{" "}
              {this.props.source.comments.substr(0, 250)}
              {this.props.source.descrip.length > 250 ? (
                <span>
                  ...
                  <span className={this.state.commentsExpanded ? "hidden" : ""}>
                    <IconButton
                      color="default"
                      aria-label="Show more"
                      onClick={this.toggleCommentsExpand}
                    >
                      <ExpandMoreIcon />
                    </IconButton>
                  </span>
                  ...
                  <Collapse
                    in={this.state.commentsExpanded}
                    timeout="auto"
                    unmountOnExit
                  >
                    ...
                    {this.props.source.comments.substr(
                      250,
                      this.props.source.comments.length
                    )}
                  </Collapse>
                </span>
              ) : (
                  ...
                  <div className="map-source-line" key={idx}>
                    {line.name ? (
                      <span className="line-attr">
                        <span className="attr">Name: </span> {line.name}
                      </span>
                    ) : (
                      ""
                    )}
                    {line.type ? (
                      <span className="line-attr">
                        <span className="attr">Type: </span> {line.type}
                      </span>
                    ) : (
                      ""
                    )}
