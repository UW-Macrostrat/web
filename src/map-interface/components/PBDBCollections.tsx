...
class PBDBCollections extends Component {
  ...
  render() {
      ...
      return (
        <Paper key={idx} classes={{ root: "pbdb-collection-paper" }}>
          <Tabs
            ...
            onChange={(event, tab) =>
              this.handleChange(event, tab, "col" + idx)
            }
          ...
          >
            <Tab label="Info" />
            <Tab
              label={`Occurrences (${col.occurrences.length})`}
          ...
          <div className="pbdb-collection-content">
            {this.state["col" + idx] === 0 && (
              <div>
                ...
                {col.oei && (
                  <div className="map-source-attr">
                    <span className="attr">Age: </span> {col.oei} ({col.lag} -{" "}
                    {col.lag}
                ...
                {col.lt1 && (
                  <div className="map-source-attr">
                    <span className="attr">Lithology: </span>{" "}
                    {col.la1 ? col.la1 : ""} {col.lf1 ? col.lf1 : ""}{" "}
                    {col.lt1.replace('"', "")} {col.lt2 ? ", " : ""}
    ...
    return <div>{this.props.data && collections}</div>;
  }
}
