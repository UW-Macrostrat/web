...
import { DocsVideo, DocsMedia } from "./map-interface/components/docs";
...
<DocsMedia href="version-4.1.0/dark-mode.mp4" float={null} width="50%">
  Toggling "Dark mode"
</DocsMedia>

#### Map features and bug fixes

<DocsMedia href="version-4.1.0/basemap-labels.mp4" float={null} width="70%">
...
<DocsMedia href="version-4.1.0/experimental-line-symbols.mp4" float={null}>
...
<DocsMedia href="version-4.1.0/save-location.mp4" float={null} width="50%">
