...
<Version spec="4.1.0" date="February 1, 2022" />

Recover filter states from URL parameters.

Load the map info box from URL parameters.
...
Fix map settings button

Yarn v2 compilation

Added experimental line symbols
