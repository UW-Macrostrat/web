import { Version, InternalLink, DocsVideo, DocsMedia } from "./components/docs";

<Version spec="4.2.0" date="August 25, 2023" dev />
...
- Allow cross-sections to be linked to externally (example: [Kaibab Arch](https://dev.macrostrat.org/map/cross-section/-112.3775,36.6438/-111.6447,35.8481#x=-112.3983&y=36.6538&z=7.4))
...
- <InternalLink to="/map/loc/-107.7083/38.5802#x=-107.8909&y=38.7058&z=8.73km&a=132&e=76&show=satellite,geology">
    <em>Black Canyon of the Gunnison</em>, oblique satellite view
  </InternalLink>
  .
- <InternalLink to="/map/loc/-112.1976/36.0962#strat_name_concepts=11016&x=-112.236&y=36.2119&z=15.61km&a=165&e=42">
