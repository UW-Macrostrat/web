...
<div class="row slide" id="apps">
  <div class="col-xs-12 slide-container">
    ...
    <div class="donate-container">
      <h1 class="title donate-title">Donate</h1>
    ...
    <div class="row footer">
      <div class="container">
        <div class="col-sm-4" id="who-made-it">
          Produced by the <a href="http://strata.geology.wisc.edu" target="_blank">UW Macrostrat Lab</a> <a href="https://github.com/UW-Macrostrat" target="_blank"><i class="fa fa-github"></i></a>
        </div>
