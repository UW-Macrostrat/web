...
<div class="nav">
  <ul>
    <li><a href="/dev/main-page#about">About</a></li>
    <li><a href="/dev/main-page#api">API</a></li>
    <li><a href="/dev/main-page#donate">Donate</a></li>
    <li><a href="/dev/main-page#publications">Publications</a></li>
