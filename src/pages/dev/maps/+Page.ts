...
function buildOverlayStyle({
  ...
  if (layerOpacity.vector != null) {
    ...
    mapStyle.sources.burwell.tiles = [`http://localhost:8000/cdr/78c274e9575d1ac948d55a55265546d711551cdd5cdd53592c9928d502d50700/umn-usc-inferlink%200.0.4/{z}/{x}/{y}`]
  }
