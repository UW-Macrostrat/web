...
<div class="parent">
  <div class="left">
    ...
    <div class="text">
      ...
      <ul class="buttons1">
        <li><a type="button" class="btn btn12" href="/sift/#/">Search</a></li>
        <li><a type="button" class="btn btn12" href="/map/#3/40.78/-94.13">Geologic Map</a></li>
        <li><div type="button" class="btn btn12 rockd" onclick="window.location='https://rockd.org'">
