...
class Definitions extends React.Component {
  constructor(props) {
    ...
    this.stateLookup = {
      ...
      groups: {
        ...
        route: "group",
        fields: [
          { field: "col_group_id", desc: "col_group_id" },
          { field: "name", desc: "name" },
          { field: "col_group", desc: "group" },
        ],
      },
      intervals: {
        title: "Intervals",
        ...
        route: "interval",
        fields: [
          { field: "int_id", desc: "int_id" },
          { field: "name", desc: "name" },
          { field: "int_type", desc: "type" },
          { field: "abbrev", desc: "abbreviation" },
          { field: "t_age", desc: "top age" },
          { field: "b_age", desc: "bottom age" },
        ],
        sort: ["name", "int_type"],
      },
      lithologies: {
        ...
        route: "lithology",
        fields: [
          { field: "lith_id", desc: "lith_id" },
          { field: "name", desc: "name" },
          { field: "type", desc: "type" },
          { field: "class", desc: "class" },
          { field: "color", desc: "color" },
        ],
      ...
      columns: {
        ...
        route: "column",
        fields: [
          { field: "col_id", desc: "col_id" },
          { field: "col_name", desc: "name" },
          { field: "status", desc: "active" },
          { field: "col_group_id", desc: "group" },
        ],
      },
      strat_names: {
        ...
        route: "strat_name",
        fields: [
          { field: "strat_name_id", desc: "strat_name_id" },
          { field: "strat_name_long", desc: "name" },
          { field: "rank", desc: "rank" },
          { field: "t_units", desc: "total units" },
        ],
      },
      strat_name_concepts: {
        ...
        fields: [
          { field: "concept_id", desc: "concept_id" },
          { field: "name", desc: "name" },
          { field: "province", desc: "province" },
          { field: "geologic_age", desc: "age" },
        ],
      },
    };
  }
  ...
  _update(type) {
    ...
    Utilities.fetchData(
      `defs/${this.stateLookup[type].def}?all`,
      (error, data) => {
  ...
  filter() {
    ...
    var filtered = this.state.data.filter((d) => {
      if (
        d[this.stateLookup[this.state.type].name]
          .toLowerCase()
          .startsWith(input)
      ) {
        return d;
                ...
                return (
                  ...
                  >
                    {this.stateLookup[this.state.type].fields.map((j, jidx) => {
                      return <td key={jidx}>{d[j.field]}</td>;
                    })}
                  </tr>
                );
              })}
