...
var SiftRouter = Router.create({
   ...
   routes:  (
     <Route handler={App}>
       ...
       <Route name='lithology_type' path='lithology_type/:id' handler={Lithology}/>
       <Route name='lithology_class' path='lithology_class/:id' handler={Lithology}/>

       <Route name='environment' path='environment/:id' handler={Environment}/>
       <Route name='environment_type' path='environment_type/:id' handler={Environment}/>
       <Route name='environment_class' path='environment_class/:id' handler={Environment}/>

       <Route name='economic' path='economic/:id' handler={Economic}/>
       <Route name='economic_type' path='economic_type/:id' handler={Economic}/>
       <Route name='economic_class' path='economic_class/:id' handler={Economic}/>
