...
export function Page() {
    ...
    return h(ContentPage, [
        ...
        h('p', [
            ...
            h('a', { href: 'https://weblex.canada.ca/weblexnet4/weblex_e.aspx' }, 'WebLex'),
            ', the USGS\'s ',
        ...
        h(LinkCard, { href: '/lex/strat-names', title: 'Stratigraphic names' }, 'Names of rock units, organized hierarchically'),
        h(LinkCard, { href: '/lex/strat-name-concepts', title: 'Stratigraphic concepts' }, 'Concepts that capture relationships between differently-named rock units'),

        h('h2', 'Dictionaries'),

        h(LinkCard, { href: '/lex/intervals', title: 'Intervals' }, 'Time intervals'),
        h(LinkCard, { href: '/lex/timescales', title: 'Timescales' }, 'Continuous representations of relative geologic time'),
        h(LinkCard, { href: '/lex/lithology', title: 'Lithologies' }, 'Names of geologic materials'),
        h(LinkCard, { href: '/lex/environments', title: 'Environments' }, 'Depositional environments and formation mechanisms'),
        h(LinkCard, { href: '/lex/economics', title: 'Economics' }, 'Economic uses of geologic materials'),
