/** `/dev/column-editor-2/new` — start a column from nothing.
 *
...
import { type ColumnEditorData, EDITOR_BASE, draftColumn } from "../data";
...
export function Page() {
  ...
  if (draft != null) {
    return h(ColumnEditorPage, draft);
  }
  ...
  return h(HybridPage, {
    ...
    content: h("div.new-column-form", [
      ...
      h("div.form-actions", [
        ...
        h(AnchorButton, { text: "Cancel", href: EDITOR_BASE, minimal: true }),
      ]),
      h(
        Callout,
